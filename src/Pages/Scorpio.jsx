...
export default function BMWCarRental() {
  ...
  const carImages = [
    'https://imgd.aeplcdn.com/664x374/n/cw/ec/40432/scorpio-n-exterior-right-front-three-quarter-74.jpeg?isig=0&q=80',
  ...
  return (
    <div className="max-w-7xl mx-auto !p-6 font-sans !mt-10 !ml-70">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <img src={selectedImage} alt="Selected" className="w-full h-96 object-cover rounded-lg shadow" />
