...
export default function BMWCarRental() {
  ...
  const [selectedImage, setSelectedImage] = useState('https://imgd.aeplcdn.com/664x374/n/cw/ec/106815/creta-exterior-right-front-three-quarter-2.jpeg?isig=0&q=80');
  ...
  const carImages = [
    ...
    'https://imgd.aeplcdn.com/664x374/n/cw/ec/106815/creta-exterior-left-side-view-4.jpeg?isig=0&q=80',
  ];
  ...
  const carSpecs = [
    ...
    { name: 'Engine', value: '1493 cc' },
    { name: 'Year', value: '2023' },
    { name: 'Mileage', value: '200' },
    { name: 'Transmission', value: 'Manual' },
    { name: 'Drive', value: 'RWD' },
    { name: 'Fuel Economy', value: '17 to 20 kmpl' },
    { name: 'Exterior Color', value: 'Robust Emerald Pearl' },
  ...
  const handleBookNow = () => {
    alert('Booking confirmed for the Hyundai Creta!');
  };
    ...
    <div className="max-w-7xl mx-auto !p-6 font-sans !mt-10 !ml-70">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-blue-900 !mt-6 !mb-2">Hyundai Creta 2024</h1>
          <p className="text-gray-700 !mb-4">
          This mid-size SUV looks premium with consistent quality. Its cabin is spacious and gets modern equipment as well. 
          It drives well whether one chooses the petrol or diesel engine powertrain with smooth gearboxes.
          </p>
