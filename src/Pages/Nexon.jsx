...
export default function BMWCarRental() {
  ...
  const [selectedImage, setSelectedImage] = useState('https://imgd.aeplcdn.com/664x374/n/cw/ec/149123/nexon-ev-exterior-right-front-three-quarter-74.jpeg?isig=0&q=80');

  const carImages = [
    'https://imgd.aeplcdn.com/664x374/n/cw/ec/149123/nexon-ev-exterior-right-front-three-quarter-74.jpeg?isig=0&q=80',
    ...
    <div className="max-w-7xl mx-auto !p-6 font-sans !mt-10 !ml-70">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-blue-900 !mt-6 !mb-2">Tata Nexon EV</h1>
          <p className="text-gray-700 !mb-4">
          The Nexon EV, an electric SUV, has impressive range, swift acceleration, and ample interior space. Apart from that, 
          the good ride and handling, sleek design, fast charging capability, and advanced features like regenerative braking make it a compelling choice.
          </p>
        ...
        <div className="bg-white !p-6 rounded-lg shadow-md sticky top-10">
          <div className="!mb-4 bg-gray-100 justify-between text-center !ml-40 !pt-5 w-50 h-30">
            ...
            <p className="text-4xl font-bold text-blue-900">₹2000</p>
          </div>
