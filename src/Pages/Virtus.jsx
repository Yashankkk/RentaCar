...
export default function BMWCarRental() {
  ...
  const carImages = [
    ...
    'https://imgd.aeplcdn.com/1056x594/n/cw/ec/121443/volkswagen-virtus-right-rear-three-quarter20.jpeg?isig=0&wm=1&q=80',
  ];
  ...
  const carSpecs = [
    ...
    { name: 'Engine', value: '1498 cc' },
    { name: 'Year', value: '2024' },
    { name: 'Mileage', value: '200' },
    { name: 'Transmission', value: 'Automatic' },
    { name: 'Drive', value: 'RWD' },
    { name: 'Fuel Economy', value: '18 to 21 kmpl' },
    { name: 'Exterior Color', value: 'Carbon Steel Grey' },
  ...
  const handleBookNow = () => {
    alert('Booking confirmed for the Virtus!');
  };
    ...
    <div className="max-w-7xl mx-auto !p-6 font-sans !mt-10 !ml-70">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-blue-900 !mt-6 !mb-2">Volkswagen Virtus</h1>
          <p className="text-gray-700 !mb-4">
          The Volkswagen Virtus is a good-looking sedan with a robust build. It offers ample legroom and modern equipment, 
          including powered and ventilated front seats. It's not only known for its fuel efficiency, safety, and reliability, but also offers a smooth driving experience.
          </p>
        ...
        <div className="bg-white !p-6 rounded-lg shadow-md sticky top-10">
          <div className="!mb-4 bg-gray-100 justify-between text-center !ml-40 !pt-5 w-50 h-30">
            ...
            <p className="text-4xl font-bold text-blue-900">₹2700</p>
          </div>
