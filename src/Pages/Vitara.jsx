...
export default function BMWCarRental() {
  ...
  const [selectedImage, setSelectedImage] = useState('https://imgd.aeplcdn.com/664x374/n/cw/ec/123185/grand-vitara-exterior-left-side-view-2.webp?isig=0&q=80');

  const carImages = [
    'https://imgd.aeplcdn.com/664x374/n/cw/ec/123185/grand-vitara-exterior-front-view.jpeg?isig=0&q=80',
    ...
    'https://imgd.aeplcdn.com/664x374/n/cw/ec/123185/grand-vitara-exterior-left-side-view-2.webp?isig=0&q=80',
  ];
    ...
    <div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-blue-900 !mt-6 !mb-2">Maruti Grand Vitara</h1>
          <p className="text-gray-700 !mb-4">
          The Grand Vitara is a premium and stylish mid-size SUV with a spacious and feature-rich cabin. 
          It has a comfortable ride and known for its good fuel efficiency for the CNG and strong-hybrid variants.
          </p>
